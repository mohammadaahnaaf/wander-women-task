        ...
        <>
            ...
            <div className="grid h-full w-full items-center">
                <div className="gap-4 max-w-4xl bg-gradient-to-tr from-green-50 via-pink-50 to-purple-50 rounded-md shadow-xl py-14 px-5 mx-auto w-full grid ">
                    ...
                    <button className=" h-14 flex gap-2 items-center text-lg text-center justify-center font-semibold text-gray-50 px-10 bg-pink-500 duration-500 hover:bg-pink-700 rounded-md" onClick={handleSignup}>
                        Signup
                    </button>

                    <div className="flex items-center justify-center px-2">
                        <Link className="font-semibold hover:text-pink-500 duration-500 text-pink-700" href='/login'>Already have an account?</Link>
                    </div>
